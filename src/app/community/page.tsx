    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans text-gray-900 pb-20">
      <main className="flex-1 max-w-md mx-auto px-4 py-6 w-full space-y-4">
        ...
        <div className="py-2 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-black text-gray-900 tracking-tight">💬 풍양중 스페이스</h1>
            <p className="text-xs text-gray-500 mt-0.5">우리 학교 학생들끼리 자유롭게 소통하는 커뮤니티</p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm space-y-3">
          <textarea 
            ...
            className="w-full text-xs bg-gray-50 rounded-xl p-3 border-none focus:outline-none focus:ring-1 focus:ring-blue-500/30 resize-none h-16 text-gray-700 font-medium"
            disabled
          />
          <div className="flex justify-between items-center pt-1">
            ...
            <button className="bg-blue-600 text-white font-bold px-4 py-2 rounded-xl text-xs flex items-center gap-1 opacity-60 cursor-not-allowed">
        ...
        <div className="space-y-3">
          {posts.map((post) => (
            <div key={post.id} className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm space-y-3 hover:shadow-md transition-shadow">
